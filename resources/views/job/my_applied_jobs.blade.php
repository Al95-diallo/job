...
@include('includes.inner_page_title', ['page_title'=>__('Liste de mes candidatures')])
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    <h3>{{__('Liste de mes candidatures')}}</h3>
                    <ul class="searchList">
                        <!-- job start --> 
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="listbtn"><a href="{{route('job.detail', [$job->slug])}}">{{__('Voir les details')}}</a></div>
                                </div>
                            </div>
