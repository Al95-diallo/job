...
@include('includes.inner_page_title', ['page_title'=>__('Candidatures embauchées')])
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    <h3>{{__('Candidatures embauchées')}}</h3>
                    <ul class="searchList">
                        <!-- job start --> 
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="listbtn"><a href="{{route('applicant.profile', $job_application->id)}}">{{__('Voir le Profile')}}</a></div>
                                </div>
                            </div>
