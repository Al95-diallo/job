...
<form action="{{route('job.seeker.list')}}" method="get">
    <div class="searchbar">
        ...
        <div class="col-md-3">
            <span id="state_dd">
                {!! Form::select('state_id[]', ['' => __('Selectionnez la Région')], Request::get('state_id', null), array('class'=>'form-control', 'id'=>'state_id')) !!}
            </span>
        </div>
        <div class="col-md-3">
            <span id="city_dd">
...
<form action="{{route('job.list')}}" method="get">
    <div class="searchbar">
		...
		<div class="input-group">
		  <input type="text"  name="search" id="jbsearch" value="{{Request::get('search', '')}}" class="form-control" placeholder="{{__('Entrez les compétences ou les détails du demandeur d\'emploi')}}" autocomplete="off" />
		  <span class="input-group-btn">
