    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 col-sm-6"> 
                <!--app info Start-->
                <div class="titleTop">
                    <div class="subtitle">{{__('Étape avant-propos maintenant')}}</div>
                    <h3>{{__('L'application GuinéeWally')}}</h3>
                </div>
                <div class="subtitle2">{{__('Un monde d'opportunités dans votre main')}}</div>
