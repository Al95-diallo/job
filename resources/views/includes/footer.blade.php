    ...
    <div class="container">
        <div class="row"> 
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    <li><a href="{{ route('index') }}">{{__('Acceuil')}}</a></li>
                    <li><a href="{{ route('contact.us') }}">{{__('Contactez')}}</a></li>
                    <li class="postad"><a href="{{ route('post.job') }}">{{__('Publier une offre')}}</a></li>
            ...
            <div class="col-md-3 col-sm-6">
                <h5>{{__('Emplois par domaine fonctionnel')}}</h5>
                <!--Quick Links menu Start-->
                <ul class="quicklinks">
                    @php
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('Tous les droits sont réservés')}}. {{__('Conçu par')}}: <a href="{{url('/')}}http://graphicriver.net/user/ecreativesol" target="_blank">eCreativeSolutions</a></div>
            </div>
            <div class="col-md-4">
