<div class="section">
    <div class="container"> 
        <!-- title start -->
        <div class="titleTop">
            <div class="subtitle">{{__('Içi vous pouvez voir')}}</div>
            <h3>{{__('Dernière')}} <span>{{__('Blogs')}}</span></h3>
        </div>
        <!-- title end -->
                        ...
                        <li class="col-lg-4">
                            <div class="bloginner">
                                ...
                                <div class="post-header">
                                    ...
                                    <div class="postmeta">Categories: {!!implode(', ',$cate_array)!!}
                                    </div>
                                </div>
        ...
        <!--view button-->
        <div class="viewallbtn"><a href="{{route('blogs')}}">{{__('
Voir tous les articles de blog')}}</a></div>
        <!--view button end--> 
    </div>
</div>