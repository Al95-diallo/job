<div class="section">
    <div class="container"> 
        <!-- title start -->
        <div class="titleTop">
            <h3>{{__('Emplois en ')}} <span>{{__('vedette')}}</span></h3>
        </div>
        <!-- title end --> 
            ...
            <li class="col-md-6">
                <div class="jobint">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3"><a href="{{route('job.detail', [$featuredJob->slug])}}" class="applybtn">{{__('Voir les details')}}</a></div>
                    </div>
                </div>
            </li>
            <!--Job end--> 
        ...
        <!--button start-->
        <div class="viewallbtn"><a href="{{route('job.list', ['is_featured'=>1])}}">{{__('Voir tous les Emplois')}}</a></div>
        <!--button end--> 
    </div>
</div>