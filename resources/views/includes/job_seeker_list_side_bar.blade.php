<div class="col-md-3 col-sm-6"> 
    ...
    <div class="sidebar">
        ...
        <!-- Jobs By Country -->
        <div class="widget">
            <h4 class="widget-title">{{__('par pays')}}</h4>
        ...
        <!-- Jobs By State -->
        <div class="widget">
            <h4 class="widget-title">{{__('par Région')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By City -->
        <div class="widget">
            <h4 class="widget-title">{{__('par ville')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Experience -->
        <div class="widget">
            <h4 class="widget-title">{{__('par expériences')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Par niveau de carrière')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Gender -->
        <div class="widget">
            <h4 class="widget-title">{{__('par sexe')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Industry -->
        <div class="widget">
            <h4 class="widget-title">{{__('par Domaines')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Skill -->
        <div class="widget">
            <h4 class="widget-title">{{__('Par compétence')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Salary -->
        <div class="widget">
            <h4 class="widget-title">{{__('Salaire à partir de')}}</h4>
            <div class="form-group">
                {!! Form::number('current_salary', Request::get('current_salary', null), array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>__('salaire actuel'))) !!}
            </div>
            <div class="form-group">
                {!! Form::number('expected_salary', Request::get('expected_salary', null), array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('pretentions'))) !!}
            </div>
            <div class="form-group">
                {!! Form::select('salary_currency', ['' =>__('selectioner la devise du salaire')]+$currencies, Request::get('salary_currency', $siteSetting->default_currency_code), array('class'=>'form-control', 'id'=>'salary_currency')) !!}
            </div>
            <!-- Salary end --> 
