<div class="col-md-3 col-sm-6"> 
	...
	<a class="btn btn-job-alert" href="javascript:;">
		<i class="fa fa-bell" style="font-size:1.125rem;"></i> {{__('Enregisterer l\'alerte emplois')}} </a>
	@else
	...
	<a href="{{ route('post.job') }}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Publier un emploi')}}</a>
	@else
	<a href="{{url('my-profile#cvs')}}" class="btn"><i class="fa fa-file-text" aria-hidden="true"></i> {{__('Télécharger votre CV')}}</a>
	@endif
	</div>
    <!-- Side Bar start -->
    <div class="sidebar">
        ...
        <!-- Jobs By Title -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par titre')}}</h4>
            ...
            <!-- title end --> 
            <span class="text text-primary view_more hide_vm">{{__('voir plus')}}</span> </div>

        <!-- Jobs By Country -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par pays')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By State -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par région')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By City -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par ville')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Experience -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par experience')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Job Type -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par type d\'emplois')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Job Shift -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par quart de travail')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par niveau de carrière')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par niveau de diplôme')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Gender -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par sexe')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Industry -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par domaines')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Jobs By Skill -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par compétences')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par domaines fonctionnels')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Top Companies -->
        <div class="widget">
            <h4 class="widget-title">{{__('Emplois par Entreprise')}}</h4>
            <ul class="optionlist view_more_ul">
        ...
        <!-- Salary -->
        <div class="widget">
            <h4 class="widget-title">{{__('Échelle salariale')}}</h4>
            <div class="form-group">
                {!! Form::number('salary_from', Request::get('salary_from', null), array('class'=>'form-control', 'id'=>'salary_from', 'placeholder'=>__('Salaire à partir de'))) !!}
            </div>
            <div class="form-group">
                {!! Form::number('salary_to', Request::get('salary_to', null), array('class'=>'form-control', 'id'=>'salary_to', 'placeholder'=>__('Salaire à'))) !!}
            </div>
            <div class="form-group">
                {!! Form::select('salary_currency', ['' =>__('Selectionnez la devise du salaire')]+$currencies, Request::get('salary_currency'), array('class'=>'form-control', 'id'=>'salary_currency')) !!}
            </div>
            <!-- Salary end --> 
