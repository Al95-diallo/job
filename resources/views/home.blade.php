...
@include('includes.inner_page_title', ['page_title'=>__('Tableau de bord')]) 
				...
				<div class="row">
					...
					<div class="col-lg-10 col-md-10">
						...
						<div class="row">
							...
							<div class="col-lg-5"><div class="editbtbn"><a href="{{ route('my.profile') }}"><i class="fas fa-pencil-alt" aria-hidden="true"></i> Editer le Profile</a>
			 ...
			 <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="profbox">
                                ...
                                <h3><i class="fa fa-black-tie" aria-hidden="true"></i> Emplois recommandés</h3>
                   ...
                   <div class="col-lg-5">
							...
							<div class="profbox followbox">
								...
								<h3><i class="fa fa-users"></i> Mes suiveurs</h3>
								...
								<ul class="followinglist">
									...
									<li>
										...
										<a href="{{route('company.detail',$company->slug)}}">{{__('Voir les details')}}</a>
									</li>
                                    @endif
									@endforeach @endif
								</ul>
								<div class="allbtn"><a href="{{route('my.followings')}}"><i class="fas fa-users"></i> Voir tout</a>
								</div>
							</div>
						</div>
                    </div>
