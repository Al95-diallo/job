    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.companies') }}">Gestion des entreprise</a> <i class="fa fa-circle"></i> </li>
                <li> <span>Ajouter une nouvelles entreprise</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->        
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i>
                         <span class="caption-subject bold uppercase">Formulaire des entreprises</span> </div>
                    </div>
