...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
        {!! Form::label('skills', 'CompÃ©tences professionnelles', ['class' => 'bold']) !!}
        <?php
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
        ...
        <span id="default_state_dd">
            {!! Form::select('state_id', ['' => 'Selectionnez  la région], null, array('class'=>'form-control', 'id'=>'state_id')) !!}
        </span>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div">
        ...
        <span id="default_city_dd">
            {!! Form::select('city_id', ['' => 'Selectionnez un ville'], null, array('class'=>'form-control', 'id'=>'city_id')) !!}
        </span>
        {!! APFrmErrHelp::showErrors($errors, 'city_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_freelance') !!}">
        {!! Form::label('is_freelance', 'Est ce indÃ©pendant?', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
        {!! Form::label('salary_to', 'Salaraire à', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
        ...
        {!! Form::select('functional_area_id', ['' => 'Sélectionnez le domaine fonctionnel']+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
        ...
        {!! Form::select('job_shift_id', ['' => 'Selectionnez l\'équipe de travail ']+$jobShifts, null, array('class'=>'form-control', 'id'=>'job_shift_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div">
        ...
        {!! Form::select('gender_id', ['' => __('pas de  préférence')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        {!! Form::label('degree_level_id', 'Niveau de diplôme requis', ['class' => 'bold']) !!}                    
        {!! Form::select('degree_level_id', ['' => 'Sélectionnez le niveau de diplôme requis']+$degreeLevels, null, array('class'=>'form-control', 'id'=>'degree_level_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
        {!! Form::label('job_experience_id', 'Expérience professionnelle requise', ['class' => 'bold']) !!}                    
        {!! Form::select('job_experience_id', ['' => 'Selectionnez expérience professionnelle requise']+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')) !!}
