...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item start active">
         <a href="{{ route('admin.home') }}" class="nav-link"> <i class="icon-home">
         </i> <span class="title">Tableau de bord</span> </a> </li>
        ...
        <li class="heading">
            <h3 class="uppercase">Traduction</h3>
        </li>		
        ...
        <li class="heading">
            <h3 class="uppercase">Gestion des adresses</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase">Forfaits des utilisateurs</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase">Attribution des Offres</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase">Gestion de paramettre</h3>
        </li>		 
