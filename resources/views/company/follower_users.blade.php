...
@include('includes.inner_page_title', ['page_title'=>__('Abonnés de l\'entreprise')]) 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    <h3>{{__('Abonnés de l\'entreprise')}}</h3>
                    <ul class="searchList">
                        <!-- job start --> 
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="listbtn"><a href="{{route('user.profile', $user->id)}}">{{__('Voir le Profile')}}</a></div>
                                </div>
                            </div>
