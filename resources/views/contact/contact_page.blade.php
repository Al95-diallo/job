...
<div class="inner-page"> 
    ...
    <div class="container">
        <div class="contact-wrap">
            <div class="title"> <span>{{__('Nous sommes là pour votre aide')}}</span>
                <h2>{{__('ENTRER EN CONTACT RAPIDEMENT')}}</h2>
                <p>
                    {{__('Au moins, la terre est grande. Vive les bananes maintenant. Vous habitez aux')}}
                    <br>
                    {{__('Guinée conakry ou dans les region. Jusqu\'à ce qu\'il ait besoin d\'indemnisation')}}
                </p>
            </div>            
                <!-- Contact Info -->
				...
				<div class="row"> 
                    ...
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-envelope"></i></span>
                            <div class="information"> <strong>{{__('votre e-mail')}}:</strong>
                    ...
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-phone"></i></span>
                            <div class="information"> <strong>{{__('Telephone')}}:</strong>
                        ...
                        <form method="post" action="{{ route('contact.us')}}" name="contactform" id="contactform">
                            ...
                            <div class="row">
                                <div class="col-md-6{{ $errors->has('full_name') ? ' has-error' : '' }}">                  
                                    {!! Form::text('full_name', null, array('id'=>'full_name', 'placeholder'=>__('Nom complet'), 'required'=>'required', 'autofocus'=>'autofocus')) !!}                
                                ...
                                <div class="col-md-6{{ $errors->has('phone') ? ' has-error' : '' }}">                  
                                    {!! Form::text('phone', null, array('id'=>'phone', 'placeholder'=>__('Téléphone'))) !!}                
                                ...
                                <div class="col-md-12">
                                    <button title="" class="button" type="submit" id="submit">{{__('Envoyer')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
